...
<body>
  ...
  <p class="community-cta">Don't miss out on the incredible opportunities awaiting you ! As Your Hub Grows so does everything else related like Helping more people, Improvement to Your area, Better Prizes , More Web Pages devoloped instead of 1 every 3 months ! it could get to 1 every week ! Instead of 3 Entrepreneur's a year we have 30 Entrepreneur's a year # Imagine and 60% of profits for the community we can easy achieve this TOGETHER ! At Collabor8 we already have a Team of 15 Who are the same local people like you wanting to make a change for the better after such a hard few years ! Lets get our community back ! Join our Hub today and embark on a journey filled with discovery, connections, and memorable experiences.</p>
